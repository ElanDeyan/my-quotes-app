...
class $QuoteTableTable extends QuoteTable
  ...
  @override
  late final GeneratedColumn<int> tags = GeneratedColumn<int>(
      'tags', aliasedName, true,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('REFERENCES tag_table (id)'));
  @override
  ...
  Quote map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Quote(
      ...
      tags: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}tags']),
    );
  }
...
class Quote extends DataClass implements Insertable<Quote> {
  ...
  factory Quote.fromJson(Map<String, dynamic> json,
    ...
    return Quote(
      ...
      tags: serializer.fromJson<int?>(json['tags']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'tags': serializer.toJson<int?>(tags),
    };
  }
  ...
  Quote copyWith(
          ...
          bool? isFavorite,
          DateTime? createdAt,
          Value<int?> tags = const Value.absent()}) =>
      Quote(
        id: id ?? this.id,
...
class QuoteTableCompanion extends UpdateCompanion<Quote> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (tags.present) {
      map['tags'] = Variable<int>(tags.value);
    }
    return map;
  }
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [tagTable, quoteTable];
}
...
class $$TagTableTableFilterComposer
  ...
  ColumnFilters<int> get quotes => $state.composableBuilder(
      column: $state.table.quotes,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));

  ComposableFilter quoteTableRefs(
      ComposableFilter Function($$QuoteTableTableFilterComposer f) f) {
    final $$QuoteTableTableFilterComposer composer = $state.composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.id,
        referencedTable: $state.db.quoteTable,
        getReferencedColumn: (t) => t.tags,
...
class $$TagTableTableOrderingComposer
  ...
  ColumnOrderings<int> get quotes => $state.composableBuilder(
      column: $state.table.quotes,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
}
...
class $$QuoteTableTableOrderingComposer
  ...
  $$TagTableTableOrderingComposer get tags {
    final $$TagTableTableOrderingComposer composer = $state.composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.tags,
        referencedTable: $state.db.tagTable,
        getReferencedColumn: (t) => t.id,
        builder: (joinBuilder, parentComposers) =>
            $$TagTableTableOrderingComposer(ComposerState(
                $state.db, $state.db.tagTable, joinBuilder, parentComposers)));
    return composer;
  }
}
